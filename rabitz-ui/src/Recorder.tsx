...
export function Recorder(props: { maxRecordingTime?: number; bands?: number; visualizerStyle?: VisualizerStyle }) {
  ...
  return (
    <div
      ...
      class="flex flex-col gap-1 items-center h-full max-h-full m-w-full min-w-[320px] min-h-45 text-gray-200 rounded-lg mx-auto"
    >
      <div class="flex flex-col gap-1 justify-center w-full max-w-full m-auto">
        ...
        <div class="relative w-full flex-1 p-0">
          <div id="rb-meter-container" class=" w-full h-full">
